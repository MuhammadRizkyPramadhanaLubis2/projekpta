...
function site_pages(): array
{
    ...
    return [
        ...
        'evaluasi-akip' => [
            'title' => 'Evaluasi AKIP',
            'subtitle' => 'Evaluasi atas implementasi SAKIP',
            'body' => [
                'Penguatan akuntabilitas kinerja dilaksanakan untuk mewujudkan pemerintahan yang bersih, akuntabel, kapabel, dan meningkatkan kualitas pelayanan publik.',
                'Evaluasi AKIP meliputi perencanaan kinerja, pengukuran kinerja, pelaporan kinerja, evaluasi internal, dan capaian kinerja.',
                'Aplikasi SEMAR menjadi sarana evaluasi elektronik bagi evaluator Badan Pengawasan Mahkamah Agung RI.',
            ],
            'list' => array_merge($sakipLaw, ['Keputusan Kepala Badan Pengawasan MARI Nomor 90 Tahun 2023 tentang penggunaan aplikasi SEMAR.']),
            'sections' => [
                ['title' => 'Laporan Hasil Evaluasi PTA Medan', 'items' => ['LHE 2022.', 'LHE PTA Tahun 2023.']],
                ['title' => 'Tindak Lanjut Hasil Evaluasi PTA Medan', 'items' => ['TLHE AKIP 2022.', 'TLHE AKIP 2023 PTA Medan.']],
                ['title' => 'Tindak Lanjut Hasil Evaluasi Satker', 'items' => ['Ruang dokumen tindak lanjut satuan kerja.']],
            ],
        ],
        'e-monev-bappenas' => [
